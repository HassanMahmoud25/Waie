      ...
      <div className="admin-panel grid gap-6 p-5 sm:p-8">
        ...
        <div>
          ...
          <p id="audioUrl-hint" className="mt-2 text-sm leading-7 text-[var(--ink-soft)]">
            اختياري. يُستخدم تلقائيًا صوت الحلقة من بودكاست وعي عند توفره؛ هذا الحقل لتجاوزه أو لحلقة غير موجودة في البودكاست. اتركه فارغًا للاعتماد على البودكاست. لا تُقبل روابط يوتيوب.
          </p>
        </div>
