...
export const hostProfiles: Record<string, HostProfile> = {
  "ahmed-amer": {
    ...
    roleInWaie: "أحد مقدّمي وعي الثلاثة، يجلب إلى الحوار عمقًا في القرآن والسيرة ونَفَسًا تأمليًا هادئًا.",
    videos: [
      {
        id: "p_9AXliS6A4",
  ...
  "sherif-ali": {
    ...
    roleInWaie: "أحد مقدّمي وعي الثلاثة، عُرف بأسلوبه المباشر في مخاطبة الشباب بقضاياهم الفعلية.",
    videos: [
      {
        id: "4EhYfc_8gyg",
  ...
  "hazem-elseddiq": {
    ...
    roleInWaie: "أحد مقدّمي وعي الثلاثة، يجلب حِرفة الحوار الطويل وزاوية حياتية معاصرة اكتسبها من سنوات إدارة HazCast.",
    videos: [
      {
        id: "KY2KFf3swFU",
